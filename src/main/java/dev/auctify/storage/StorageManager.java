 ...
 * and MySQL (production-scale) storage. All implementations must be safe to
...
public interface StorageManager {
    ...
    /**
     * Retrieves all active listings from persistent storage. Used on plugin startup
     * to reload listings into memory.
     */
    ...
    /**
     * Atomically fetches and clears all pending deliveries for a player. Prevents
     * TOCTOU duplication if called concurrently.
     */
    ...
    /** Gets the average rating for a seller. Returns -1 if no ratings. */
    ...
    /**
     * Gets price statistics for an item type from auction history. Returns
     * [avgPrice, minPrice, maxPrice, count] or null if no data.
     */
